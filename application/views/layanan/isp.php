   ...
   <div class="container content">
                        ...
                        <div class="carousel slide carousel-v1" id="myCarousel">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img alt="" src="<?php echo base_url(); ?>assets/img-temp/promo/194.jpg">
                                </div>
                            </div>
                    ...
                    <h2><strong><a class="text-uppercase" style="text-decoration: none; color:black !important;">Internet Services Provider</a></strong></h2>
