   ...
   <div class="container content">
                        ...
                        <div class="carousel slide carousel-v1" id="myCarousel">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img alt="" src="<?php echo base_url(); ?>assets/img/portofolio/sppd/1.jpg">
                                </div>
                    ...
                    <h2><strong><a class="text-uppercase" style="text-decoration: none; color:black !important;">E-SPPD BPPRD Kabupaten Baru Bara.</a></strong></h2>
